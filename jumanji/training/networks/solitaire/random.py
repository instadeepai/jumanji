...
def make_random_policy_solitaire(solitaire: Solitaire) -> RandomPolicy:
    """Make random policy for Solitaire."""
    return make_masked_categorical_random_ndim(solitaire.action_spec().num_values)
