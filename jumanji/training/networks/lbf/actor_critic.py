...
from jumanji.environments.routing.lbf.types import Observation
...
def make_actor_critic_networks_lbf(
    lbf_env: LevelBasedForaging,
...
class LevelBasedForagingTorso(hk.Module):
    def __init__(
        self,
        transformer_num_blocks: int,
        transformer_num_heads: int,
...
def make_actor_network(
    ...
    def network_fn(observation: Observation) -> chex.Array:
        ...
        head = hk.nets.MLP((*transformer_mlp_units, 6), activate_final=False)
