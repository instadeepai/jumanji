...
class TestObservationSpec:
    ...
    @pytest.mark.parametrize(
        "arg_name, new_value",
        [
            ("board_spec", observation_spec.board_spec.replace(shape=(6, 6))),
    ...
    def test_observation_spec__replace(self, arg_name: str, new_value: Any) -> None:
        """Test the replace method of ObservationSpec."""
        ...
        for attr_name in {"board_spec", "action_mask_spec"}.difference([arg_name]):
            chex.assert_equal(
