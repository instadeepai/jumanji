...
from jumanji.environments.packing.bin_pack.reward import sparse_linear_reward
from jumanji.environments.packing.bin_pack.types import State


def test__sparse_linear_reward(bin_pack_env: BinPack, dummy_instance: State) -> None:
    ...
    next_state, _ = bin_pack_env.step(dummy_instance, jnp.array([0, 0]))
