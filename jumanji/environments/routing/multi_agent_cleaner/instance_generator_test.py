...
from jumanji.environments.routing.multi_agent_cleaner.stack import Stack, stack_pop
...
def all_tiles_connected(maze: Maze) -> bool:
    ...
    all others.
    """
    # replace walls by 0 and dirty by 1
...
class TestInstanceGenerator:
    ...
    def test_split_vertically(
        ...
        state = InstanceGeneratorState(maze, chambers, key)
